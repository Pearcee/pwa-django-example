...
SECRET_KEY = 'ol+=w+20%xs++smgh!cn_+4hx%lxi7a1%(p**e)=o#mlzncbfg'
...
PWA_APP_ICONS = [ { 'src': '/static/images/my_app_icon.png', 'sizes': '160x160' }, 
    { 'src': '/static/images/my_app_icon.png', 'sizes': '192x192' },
     { 'src': '/static/images/my_app_icon.png', 'sizes': '512x512' } ] 
PWA_APP_ICONS_APPLE = [ { 'src': '/static/images/my_apple_icon.png', 'sizes': '160x160' } ] 
PWA_APP_SPLASH_SCREEN = [ { 'src': '/static/images/icons/512.png', 'media': '(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)' } ] 
PWA_APP_DIR = 'ltr' 
PWA_APP_LANG = 'en-US'